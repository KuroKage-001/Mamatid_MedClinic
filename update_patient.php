...
if (isset($_POST['save_Patient'])) {
    ...
    $purpose = trim($_POST['purpose']); // updated: using "purpose" instead of "cnic"
    ...
    if ($patientName != '' && $address != '' && 
        $purpose != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                <div class="form-group">
                  ...
                  <div class="input-group date" id="date_of_birth" data-target-input="nearest">
                    <input type="text" class="form-control form-control-sm rounded-0 datetimepicker-input" data-target="#date_of_birth" name="date_of_birth" value="<?php echo $dob;?>" />
