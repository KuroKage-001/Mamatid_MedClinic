...
try {
    if ($show_archived) {
        $query = "SELECT id, name, age,
                         ...
                         archive_reason,
                         (SELECT display_name FROM admin_user_accounts WHERE id = general_deworming.archived_by) as archived_by_name
...
<head>
  ...
  <style>
    ...
    #all_deworming_wrapper .row:first-child {
      margin-bottom: 15px;
    }

    #all_deworming_wrapper .dataTables_filter {
      float: left !important;
      text-align: left !important;
    }

    #all_deworming_wrapper .dataTables_filter input {
      width: 300px;
      border-radius: 8px;
      border: 2px solid #e4e6ef;
      padding: 0.625rem 1rem;
    ...
    #all_deworming_wrapper .dataTables_filter input:focus {
      border-color: var(--primary-color);
      box-shadow: 0 0 0 0.2rem rgba(54, 153, 255, 0.25);
    }
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                  <div class="form-group">
                    ...
                    <div class="input-group date" id="birthday" data-target-input="nearest">
                      <input type="text" class="form-control datetimepicker-input" 
                             data-target="#birthday" name="birthday" placeholder="Select birthday"
                             data-toggle="datetimepicker" autocomplete="off" required />
      ...
      <section class="content">
        <div class="card card-outline card-primary">
          <div class="card-header">
            <h3 class="card-title"><?php echo $show_archived ? 'Archived Deworming Records' : 'Active Deworming Records'; ?></h3>
            <div class="card-tools">
              <div class="d-flex align-items-center">
                <a href="general_deworming.php" 
                   class="archive-filter-btn <?php echo !$show_archived ? 'active' : ''; ?>">
                  <i class="fas fa-list"></i> Active Records
                </a>
                <a href="general_deworming.php?show_archived=1" 
                   class="archive-filter-btn <?php echo $show_archived ? 'active' : ''; ?>">
      ...
      function archiveRecord(id, name) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            fetch('actions/archive_deworming.php', {
              method: 'POST',
              headers: {
      ...
      function unarchiveRecord(id, name) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            fetch('actions/unarchive_deworming.php', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
              },
