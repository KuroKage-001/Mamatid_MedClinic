...
// Handle form submission to update family planning record
...
// Retrieve the family planning record for editing
try {
...
<head>
  ...
  <title>Update Family Planning - Mamatid Health Center System</title>
</head>
      ...
      <section class="content">
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">UPDATE FAMILY PLANNING RECORD</h3>
            ...
            <form method="post">
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                  <button type="submit" id="update_family" name="update_family" 
