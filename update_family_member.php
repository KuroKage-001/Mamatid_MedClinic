...
// Handle form submission to update family member record
if (isset($_POST['update_family_member'])) {
    ...
    if ($serialNumber != '' && $name != '' && $date != '') {
        ...
        try {
            ...
            $stmt->execute();
            $con->commit();
            $message = 'Family member record updated successfully.';
...
// Retrieve the family member record for editing
try {
      ...
      <section class="content">
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">UPDATE FAMILY MEMBER RECORD</h3>
            ...
            <form method="post">
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                  <button type="submit" id="update_family_member" name="update_family_member" 
