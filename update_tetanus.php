            ...
            <section class="content">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-edit mr-2"></i>Edit Tetanus Record
                        </h3>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" id="updateForm">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" id="age" name="age" required
                                           class="form-control" value="<?php echo htmlspecialchars($record['age']); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" id="diagnosis" name="diagnosis"
                                           class="form-control" value="<?php echo htmlspecialchars($record['diagnosis']); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <textarea id="remarks" name="remarks" class="form-control"
                                              rows="3"><?php echo htmlspecialchars($record['remarks']); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="action-buttons">
                                ...
                                <button type="submit" id="update_tetanus" name="update_tetanus" class="btn btn-primary">
            ...
            $('#deleteBtn').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'actions/delete_tetanus.php?id=<?php echo $id; ?>';
                    }
                });
            });
