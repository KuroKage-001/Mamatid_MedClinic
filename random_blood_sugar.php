...
<body class="hold-transition sidebar-mini light-mode layout-fixed layout-navbar-fixed">
  <div class="wrapper">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          ...
          <div class="card-body">
            <div class="row table-responsive">
              <table id="all_blood_sugar" class="table table-striped dataTable table-bordered dtr-inline" role="grid" aria-describedby="all_blood_sugar_info">
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Name</th>
    ...
    <script>
      ...
      $(function () {
        $("#all_blood_sugar").DataTable({
          "responsive": true,
          "lengthChange": false,
          "autoWidth": false,
          "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
        }).buttons().container().appendTo('#all_blood_sugar_wrapper .col-md-6:eq(0)');
      });
    </script>
</body>
</html> 