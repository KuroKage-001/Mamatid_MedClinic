          ...
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
              <div class="archive-filter-tabs">
                <a href="general_family_planning.php" class="btn <?php echo !$show_archived ? 'btn-primary' : 'btn-secondary'; ?>">
                  <i class="fas fa-users"></i> Active Records
                </a>
                <a href="general_family_planning.php?show_archived=1" class="btn <?php echo $show_archived ? 'btn-warning' : 'btn-secondary'; ?>">
      ...
      function archiveRecord(id, name) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = 'actions/archive_family_planning.php';
      ...
      function unarchiveRecord(id, name) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'actions/unarchive_family_planning.php';
