...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $birthday_obj = DateTime::createFromFormat('m/d/Y', $birthday);
            if (!$birthday_obj) {
                throw new Exception("Invalid birthday format");
            }
            $formatted_birthday = $birthday_obj->format('Y-m-d');
      ...
      <section class="content">
        <div class="card card-outline card-primary">
          <div class="card-header">
            <h3 class="card-title">
              <i class="fas fa-edit mr-2"></i>Edit Deworming Record
            </h3>
                ...
                <div class="col-md-6">
                  <label class="form-label">Birthday</label>
                    ...
                    <input type="text" class="form-control datetimepicker-input" 
                           ...
                           data-toggle="datetimepicker" autocomplete="off" required
                           value="<?php echo htmlspecialchars($record['birthday']); ?>"/>
